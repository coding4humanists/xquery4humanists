...
layout: page
title: Pp. 238 (no. 277)
permalink: /code/277-pp238/
---

This code sample is adapted from Clifford B. Anderson and Joseph C. Wicentowski, 
[_XQuery for Humanists_](/) (College Station: Texas A&M University Press, 2020), 238. 
Download this code sample in its [raw form](/code/277-pp238/277-pp238.xq).
View the source on [GitHub](https://github.com/coding4humanists/xquery4humanists/blob/release/code/277-pp238/277-pp238.xq).
...
$lines contains text ("thing"ftand "best")
```  
