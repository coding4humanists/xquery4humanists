...
layout: page
title: Pp. 241 (no. 288)
permalink: /code/288-pp241/
---

This code sample is adapted from Clifford B. Anderson and Joseph C. Wicentowski, 
[_XQuery for Humanists_](/) (College Station: Texas A&M University Press, 2020), 241. 
Download this code sample in its [raw form](/code/288-pp241/288-pp241.xq).
View the source on [GitHub](https://github.com/coding4humanists/xquery4humanists/blob/release/code/288-pp241/288-pp241.xq).
...
$poem contains text ("light" ftand "wink") window 1 sentences
```  
