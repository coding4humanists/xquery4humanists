...
layout: page
title: Pp. 235 (no. 261)
permalink: /code/261-pp235/
---

This code sample is adapted from Clifford B. Anderson and Joseph C. Wicentowski, 
[_XQuery for Humanists_](/) (College Station: Texas A&M University Press, 2020), 235. 
Download this code sample in its [raw form](/code/261-pp235/261-pp235.xq).
View the source on [GitHub](https://github.com/coding4humanists/xquery4humanists/blob/release/code/261-pp235/261-pp235.xq).
...
for $line in $lines
where $line contains text {"truth","pleasure", "beauty"} all
return
    $line
```  
